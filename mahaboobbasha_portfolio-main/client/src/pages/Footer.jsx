  ...
  return (
    ...
    >
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 items-center">
        ...
        <div className="space-y-4 text-center sm:text-left">
          ...
          >
            ...
            <a
              href="shaikbasham99@gmail.com"
              className="hover:text-blue-500 transition"
            >
              shaikbasham99@gmail.com
            </a>
          </motion.p>
          <motion.p
            className="flex items-center space-x-3 text-base sm:text-[10px] justify-center sm:justify-start"
        ...
        <motion.div className="flex space-x-6 justify-center">
          <motion.a
            href="https://www.linkedin.com/in/shaik-mahaboobbasha-024341201/"
            target="_blank"
          ...
          <motion.a
            href="https://github.com/bashab2023"
            target="_blank"
            rel="noopener noreferrer"
            initial="initial"
            animate="animate"
          ...
          <motion.a
            href="https://twitter.com/mahaboobsh55712"
            target="_blank"
            rel="noopener noreferrer"
            initial="initial"
            animate="animate"
      ...
      <p className="mt-8 text-center text-gray-400 text-sm">
        © 2025 Shaik Mahaboob Basha. All rights reserved.
      </p>
    </footer>
  );
}
